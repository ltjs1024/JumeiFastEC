...
import com.jm.core.util.dimen.DimenUtil;
...
public class LatteLoader {
    ...
    private static final int LOADER_ZIE_SCALE = 8;
    ...
    public static void showLoading(Context context, String type) {
        ...
        if (dialogWindow != null) {
            ...
            lp.width = deviceWidth / LOADER_ZIE_SCALE;
            lp.height = deviceHeight / LOADER_ZIE_SCALE;
